...
import com.mirkamol.popular_movies.fragment.home.HomeFragment

class TVShowAdapter(var homeFragment: HomeFragment, var items: ArrayList<TVShow>) :
    BaseAdapter() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is TVShowViewHolder) {
            ...
            holder.binding.ivMovie.setOnClickListener {
                ...
                homeFragment.viewModel.insertTVShowToDB(tvShow)
                // call Details Activity
                homeFragment.callDetailsFragment(tvShow, holder.binding.ivMovie)
            }
